    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите краткое содержание книги', max_length=100, verbose_name='Описание книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите статус книги', max_length=20, verbose_name='Статус книги')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ForeignKey(help_text='Введите название жанра для книги', max_length=30, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.genre', verbose_name='Название жанра'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
